...
def _validar_inputs():
    errores = []
    for ruta, desc in [
        (LISTA_CORTE_PATH,    "correr 5_cobranza primero"),
        (COBRANZA_FINAL_PATH, "correr 5_cobranza primero"),
        (PAGOS_YAPE_PATH,     "re-correr 4_pagos con el reporte extendido del banco"),
...
def main():
    print("\n" + "═" * 55)
    print("  6_corte — Clasificación penalidad y corte físico")
    print("═" * 55)
    _init_logging()
