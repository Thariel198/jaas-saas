...
1_lecturas
2_planilla
4_pagos/yape/construir_maestro/crear_origenes   ← estás aquí
        ↓
4_pagos/yape/construir_maestro/crear_maestro    → consolida · calcula nivel_confianza · produce maestro_yape.xlsx
        ↓
...
> Si ves algo en mz_no_encontradas con 2+ meses → revísalo en `1_lecturas`.
...
| `2+` | revisar · puede ser lote genuinamente nuevo → agrégalo en `1_lecturas` |
...
| `usuarios_id.xlsx` | se gestiona en `1_lecturas` | `shared/` |
