...
| `blancos_acumulados.xlsx` | motor_matching | 5_cobranza · 6b_override |
...
6. pagos_yape.xlsx listo → pasa a 5_cobranza
```
...
|---------|------|---------|
| `Outputs/pagos_yape.xlsx` | temporal · se borra en Ciclo 1 del mes siguiente | 5_cobranza |
...
| `Blancos/blancos_acumulados.xlsx` | permanente · crece indefinidamente | 5_cobranza · 6b_override |

---

## Lo que NO hace este módulo

- **No hace override** — las correcciones de usuario por confusión de MZ-LOTE después de que el dinero cuadró se hacen en `6b_override/` — después de corte y antes de boletas
- **No carga la planilla** — eso es responsabilidad de `5_cobranza/cargar_planilla/`
