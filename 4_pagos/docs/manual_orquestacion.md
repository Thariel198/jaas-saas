# Manual de Orquestación — 4_pagos

## ¿Qué hace este módulo?

`4_pagos` procesa dos tipos de pago de manera independiente:
...
El archivo `4_pagos/main.py` ejecuta ambos pipelines en el orden correcto.
...
| Planilla del mes | `shared/planilla_mes/` | Planilla de deudas generada en `2_planilla` |
...
python 4_pagos/main.py

# O desde dentro de 4_pagos/
python main.py
```
...
|---|---|---|
| `pagos_yape_tepago.xlsx` | `yape/motor_matching/outputs/` | `5_cobranza/inputs/pagos_yape/` |
...
| Archivo | Ubicación | Destino |
|---|---|---|
| `pagos_efectivo.xlsx` | `efectivo/outputs/` | `5_cobranza/inputs/pagos_efectivo/` |
...
¿pendientes.xlsx generado?
    ├── NO  → proceso completo, pasar a 5_cobranza
...
1. Copiar `pagos_yape_tepago.xlsx` → `5_cobranza/inputs/pagos_yape/`
2. Copiar `pagos_efectivo.xlsx` → `5_cobranza/inputs/pagos_efectivo/`
3. Ejecutar `5_cobranza/main.py`
