...
def _validar_inputs():
    ...
    for ruta, desc in [
        ...
        (PAGOS_YAPE_PATH,     "asegurar que 4_pagos ya corrió"),
        (PAGOS_EFEC_PATH,     "asegurar que pagos_efectivo.xlsx existe"),
        (COBRANZA_FINAL_PATH, "asegurar que 5_cobranza ya corrió"),
    ]:
        if not ruta.exists():
...
def main():
    print("\n" + "═" * 55)
    print("  6b_override — Corrección de pagos mal asignados")
    print("═" * 55)
    _init_logging()
