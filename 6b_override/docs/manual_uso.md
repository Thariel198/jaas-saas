...
**Después** de que `5_cobranza` ya corrió y generaste `cobranza_final.xlsx`.
...
Abrir una terminal en la carpeta `6b_override/` y ejecutar:
...
```
═══════════════════════════════════════════════════════
  6b_override — Corrección de pagos mal asignados
═══════════════════════════════════════════════════════
...
```
PRE-CONDICIONES
  5_cobranza ya corrió → cobranza_final.xlsx existe

INPUTS
  inputs/overrides.xlsx          ← llenas tú antes de correr

OUTPUTS
  pagos_yape_tepago.xlsx         ← actualizado (en 5_cobranza/inputs/pagos_yape/)
  pagos_efectivo.xlsx            ← actualizado (en 5_cobranza/inputs/pagos_efectivo/)
  cobranza_final.xlsx            ← actualizado (en 5_cobranza/outputs/)
