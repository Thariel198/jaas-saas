...
| Skill | Descripción | 10/05 | 24/05 | 31/05 | 05/06 | 07/06 | 09/06 | 11/06 | Meta | Notas |
|-------|-------------|-------|-------|-------|-------|-------|-------|-------|------|-------|
...
| Skill | Descripción | 10/05 | 24/05 | 31/05 | 05/06 | 07/06 | 09/06 | 11/06 | Meta | Notas |
|-------|-------------|-------|-------|-------|-------|-------|-------|-------|------|-------|
| Git | Control de versiones | 3/10 | 5/10 | — | — | — | — | — | 8/10 | Estable |
...
3. **Git avanzado** — `branch`, `push` a GitHub
