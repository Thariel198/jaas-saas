# Registro de decisiones — 01_lecturas
...
- *En `shared/`* — error histórico de la versión anterior. Era ambiguo "compartido con quién" (en realidad solo lo usa 01_lecturas).
