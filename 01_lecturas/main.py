"""01_lecturas/main.py — valida lecturas mensuales y orquesta el ciclo de corrección.
...
Detecta 11 anomalías (7 bloqueantes + 4 informativas) y genera:
    ...
    outputs/lecturas_planilla_YYYY-MM.xlsx — input limpio para 02_planilla (solo al cerrar)
...
def main():
    print("\n" + "═" * 65)
    print("  01_lecturas — procesamiento de lecturas del ciclo")
    print("═" * 65)
    _init_logging()
    ...
    if cerrado:
        ...
        print(f"  Siguiente: python ../02_planilla/main.py")
    else:
