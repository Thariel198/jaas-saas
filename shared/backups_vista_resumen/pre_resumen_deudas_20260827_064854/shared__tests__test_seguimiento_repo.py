...
esperadas = set(repo.CONCEPTOS_VISTA_ORDEN) | {"Ajustes"}
...
check(wb.sheetnames[:8] == list(repo.CONCEPTOS_VISTA_ORDEN),
      f"orden visible = {repo.CONCEPTOS_VISTA_ORDEN}, obtuve {wb.sheetnames[:8]}")
