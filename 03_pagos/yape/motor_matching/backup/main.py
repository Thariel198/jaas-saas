...
def exportar_pendientes(todos: list):
    ...
    # Solo 1 tipo: Sin_identificar
    sin_id = [r for r in sin_resolver if True]  # todos los que quedan
    ...
    wb.save(ruta)
    print(f"  ⚠ Pendientes: {len(sin_id)} sin identificar → {PENDIENTES_FILE}")
